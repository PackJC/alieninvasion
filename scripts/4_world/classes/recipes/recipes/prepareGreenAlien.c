class PrepareGreenAlien extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		m_AnimationLength = 1.7;//animation length in relative time units
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_GreenAlien");//you can insert multiple ingredients this way
